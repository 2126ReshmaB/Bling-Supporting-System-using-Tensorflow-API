      ...
      for i,b in enumerate(boxes[0]):
          ...
          if scores[0][i] >= 0.5:
            ...
            if apx_distance <=0.7:
              if mid_x > 0.3 and mid_x < 0.7:
                cv2.putText(image_np, 'WARNING VEHICLES APPROACHING!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
        ...
        if classes[0][i] ==44:
            if scores[0][i] >= 0.5:
                ...
                if apx_distance <=0.5:
                    if mid_x > 0.1 and mid_x < 0.8:
                        cv2.putText(image_np, 'WARNING BOTTLE IS CLOSER!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
        ...
        if classes[0][i] ==1:
            if scores[0][i] >= 0.5:
                ...
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'WARNING PERSON IS CLOSER!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
                        print("Warning -Person is very close to the frame")
                        engine.say("Warning -Person is very close to the frame")
                        engine.runAndWait()
        if classes[0][i] ==17:
            if scores[0][i] >= 0.5:
                mid_x = (boxes[0][i][1]+boxes[0][i][3])/2
                ...
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'WARNING CAT IS CLOSER!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
        ...
        if classes[0][i] ==47:
            if scores[0][i] >= 0.5:
                ...
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'WARNING CUP IS CLOSER!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
        ...
        if classes[0][i] ==84:
           if scores[0][i] >= 0.5:
               ...
               if apx_distance <=0.5:
                   if mid_x > 0.3 and mid_x < 0.7:
                       cv2.putText(image_np, 'WARNING BOOK IS CLOSER!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
        ...
        if classes[0][i] ==73:
            if scores[0][i] >= 0.5:
                ...
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'WARNING LAPTOP IS CLOSER!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
        ...
        if classes[0][i] ==74:
            if scores[0][i] >= 0.5:
                ...
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'WARNING MOUSE IS CLOSER!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
        ...
        if classes[0][i] ==89:
            if scores[0][i] >= 0.5:
                ...
                engine.say(apx_distance)
                engine.say("units")
                engine.say("Tooth brush is AT A SAFER DISTANCE")
                
                
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'WARNING TOOTH BRUSH IS CLOSER!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
                        print("Warning -tooth brush is very close to the frame")
                        engine.say("Warning -Tooth brush is very close to the frame")
                        engine.runAndWait()
        if classes[0][i] ==78:
            if scores[0][i] >= 0.5:
                mid_x = (boxes[0][i][1]+boxes[0][i][3])/2
                ...
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'WARNING MICROWAVE IS CLOSER!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
        ...
        if classes[0][i] ==56:
            if scores[0][i] >= 0.5:
                ...
                engine.say(apx_distance)
                engine.say("units")
                engine.say("BROCCOLI is AT A SAFER DISTANCE")
                
                
                if apx_distance <=0.5:
                    if mid_x > 0.3 and mid_x < 0.7:
                        cv2.putText(image_np, 'WARNING BROCCOLI IS CLOSER!!!', (50,50), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,0,255), 3)
                        print("Warning -Broccoli is very close to the frame")
                        engine.say("Warning -Broccoli is very close to the frame")
                        engine.runAndWait()
